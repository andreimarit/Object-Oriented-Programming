...
class CalcView extends JFrame {
    ...
    CalcView(CalcModel model) {
        ...
        auxPanel.add(m_multiplyBtn);
        auxPanel.add(m_addBtn);
        auxPanel.add(m_subtractBtn);
        auxPanel.add(m_divBtn);
    ...
    void addAddListener(ActionListener ad) {
    	m_addBtn.addActionListener(ad);
    }
    
    void addSubtractListener(ActionListener cal) {
        m_subtractBtn.addActionListener(cal);
    }
    
    void addDivideListener(ActionListener ad) {
    	m_divBtn.addActionListener(ad);
    }
